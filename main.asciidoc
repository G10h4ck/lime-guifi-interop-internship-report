...
All those limitations are solved using the software developed durin this works, moreover other more complex but more commone interoperability cases are possible:
